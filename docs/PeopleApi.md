# alfresco_core_api_client.PeopleApi
...
with alfresco_core_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = alfresco_core_api_client.PeopleApi(api_client)
    person_body_create = alfresco_core_api_client.PersonBodyCreate() # PersonBodyCreate | The person details.
...
with alfresco_core_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = alfresco_core_api_client.PeopleApi(api_client)
    person_id = 'person_id_example' # str | The identifier of a person.
    client_body = alfresco_core_api_client.ClientBody() # ClientBody | The client name to send email with app-specific url.
...
with alfresco_core_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = alfresco_core_api_client.PeopleApi(api_client)
    person_id = 'person_id_example' # str | The identifier of a person.
    password_reset_body = alfresco_core_api_client.PasswordResetBody() # PasswordResetBody | The reset password details
...
with alfresco_core_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = alfresco_core_api_client.PeopleApi(api_client)
    person_id = 'person_id_example' # str | The identifier of a person.
    person_body_update = alfresco_core_api_client.PersonBodyUpdate() # PersonBodyUpdate | The person details.
    fields = ['fields_example'] # List[str] | A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter.  (optional)
