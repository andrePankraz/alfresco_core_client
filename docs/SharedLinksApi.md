# alfresco_core_api_client.SharedLinksApi
...
with alfresco_core_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = alfresco_core_api_client.SharedLinksApi(api_client)
    shared_link_body_create = alfresco_core_api_client.SharedLinkBodyCreate() # SharedLinkBodyCreate | The nodeId to create a shared link for.
...
with alfresco_core_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = alfresco_core_api_client.SharedLinksApi(api_client)
    shared_id = 'shared_id_example' # str | The identifier of a shared link to a file.
    shared_link_body_email = alfresco_core_api_client.SharedLinkBodyEmail() # SharedLinkBodyEmail | The shared link email to send.
