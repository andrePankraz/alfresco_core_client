...
class TestDeletedNodesPagingList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeletedNodesPagingList:
        """Test DeletedNodesPagingList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeletedNodesPagingList`
        """
        model = DeletedNodesPagingList()
        if include_optional:
