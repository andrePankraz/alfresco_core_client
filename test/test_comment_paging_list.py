...
class TestCommentPagingList(unittest.TestCase):
    """CommentPagingList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentPagingList:
        """Test CommentPagingList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentPagingList`
        """
        model = CommentPagingList()
        if include_optional:
    ...
    def testCommentPagingList(self):
        """Test CommentPagingList"""
