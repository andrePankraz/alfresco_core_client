...
class TestSiteMemberEntry(unittest.TestCase):
    """SiteMemberEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SiteMemberEntry:
        """Test SiteMemberEntry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SiteMemberEntry`
        """
        model = SiteMemberEntry()
        if include_optional:
