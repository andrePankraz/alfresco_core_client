...
class TestVersionPagingList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VersionPagingList:
        """Test VersionPagingList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VersionPagingList`
        """
        model = VersionPagingList()
        if include_optional:
            return VersionPagingList(
                pagination = alfresco_core_api_client.models.pagination.Pagination(
                    ...
                    max_items = 56, ),
                entries = [
                    alfresco_core_api_client.models.version_entry.VersionEntry(
