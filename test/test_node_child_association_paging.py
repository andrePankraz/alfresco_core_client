...
class TestNodeChildAssociationPaging(unittest.TestCase):
    """NodeChildAssociationPaging unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeChildAssociationPaging:
        """Test NodeChildAssociationPaging
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeChildAssociationPaging`
        """
        model = NodeChildAssociationPaging()
        if include_optional:
            return NodeChildAssociationPaging(
                list = alfresco_core_api_client.models.node_child_association_paging_list.NodeChildAssociationPaging_list(
                    pagination = alfresco_core_api_client.models.pagination.Pagination(
                        ...
                        max_items = 56, ), 
                    entries = [
                        alfresco_core_api_client.models.node_child_association_entry.NodeChildAssociationEntry(
                            entry = null, )
                        ], 
    ...
    def testNodeChildAssociationPaging(self):
        """Test NodeChildAssociationPaging"""
