...
class TestDeletedNode(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeletedNode:
        """Test DeletedNode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeletedNode`
        """
        model = DeletedNode()
        if include_optional:
            return DeletedNode(
                ...
                archived_by_user = alfresco_core_api_client.models.user_info.UserInfo(
                    display_name = '', 
                    id = '', ),
