...
class TestNodeAssociation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NodeAssociation:
        """Test NodeAssociation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeAssociation`
        """
        ...
        if include_optional:
            return NodeAssociation(
                ...
                association = alfresco_core_api_client.models.association_info.AssociationInfo(
                    assoc_type = '', )
            )
        else:
            return NodeAssociation(
