...
class TestNodePagingList(unittest.TestCase):
    """NodePagingList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodePagingList:
        """Test NodePagingList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodePagingList`
        """
        model = NodePagingList()
        if include_optional:
            return NodePagingList(
                pagination = alfresco_core_api_client.models.pagination.Pagination(
                    ...
                    max_items = 56, ),
                entries = [
                    alfresco_core_api_client.models.node_entry.NodeEntry(
                        entry = alfresco_core_api_client.models.node.Node(
                            id = '', 
