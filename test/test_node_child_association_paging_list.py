...
class TestNodeChildAssociationPagingList(unittest.TestCase):
    """NodeChildAssociationPagingList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeChildAssociationPagingList:
        """Test NodeChildAssociationPagingList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeChildAssociationPagingList`
        """
        model = NodeChildAssociationPagingList()
        if include_optional:
    ...
    def testNodeChildAssociationPagingList(self):
        """Test NodeChildAssociationPagingList"""
