...
class TestCommentEntry(unittest.TestCase):
    """CommentEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentEntry:
        """Test CommentEntry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentEntry`
        """
        model = CommentEntry()
        if include_optional:
            return CommentEntry(
