...
class TestNodeAssociationPagingList(unittest.TestCase):
    """NodeAssociationPagingList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeAssociationPagingList:
        """Test NodeAssociationPagingList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeAssociationPagingList`
        """
        model = NodeAssociationPagingList()
        if include_optional:
    ...
    def testNodeAssociationPagingList(self):
        """Test NodeAssociationPagingList"""
