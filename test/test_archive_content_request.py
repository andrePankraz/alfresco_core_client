...
class TestArchiveContentRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ArchiveContentRequest:
        """Test ArchiveContentRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArchiveContentRequest`
        """
        model = ArchiveContentRequest()
        if include_optional:
