...
class TestPersonPaging(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PersonPaging:
        """Test PersonPaging
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonPaging`
        """
        model = PersonPaging()
        if include_optional:
            return PersonPaging(
                list = alfresco_core_api_client.models.person_paging_list.PersonPaging_list(
