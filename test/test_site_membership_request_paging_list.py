...
class TestSiteMembershipRequestPagingList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SiteMembershipRequestPagingList:
        """Test SiteMembershipRequestPagingList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SiteMembershipRequestPagingList`
        """
        model = SiteMembershipRequestPagingList()
        if include_optional:
