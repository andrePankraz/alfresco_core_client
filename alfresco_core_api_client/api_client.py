...
import alfresco_core_api_client.models
from alfresco_core_api_client import rest
from alfresco_core_api_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(alfresco_core_api_client.models, klass)
