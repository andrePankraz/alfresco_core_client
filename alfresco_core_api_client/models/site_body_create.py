...
class SiteBodyCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "description", "visibility"]

    @field_validator('visibility')
    def visibility_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('PUBLIC', 'PRIVATE', 'MODERATED'):
            raise ValueError("must be one of enum values ('PUBLIC', 'PRIVATE', 'MODERATED')")
        return value
