...
class ActionParameterDefinition(BaseModel):
    ...
    parameter_constraint_name: Optional[StrictStr] = Field(default=None, alias="parameterConstraintName")
    __properties: ClassVar[List[str]] = ["name", "type", "multiValued", "mandatory", "displayLabel", "parameterConstraintName"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "parameterConstraintName": obj.get("parameterConstraintName")
        })
        return _obj
