...
class ContentInfo(BaseModel):
    ...
    mime_type_name: Optional[StrictStr] = Field(default=None, alias="mimeTypeName")
    size_in_bytes: Optional[StrictInt] = Field(default=None, alias="sizeInBytes")
    encoding: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["mimeType", "mimeTypeName", "sizeInBytes", "encoding"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "mimeTypeName": obj.get("mimeTypeName"),
