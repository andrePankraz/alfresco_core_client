...
class SiteMembershipRequestWithPersonPagingList(BaseModel):
    """
    SiteMembershipRequestWithPersonPagingList
    """ # noqa: E501
    pagination: Pagination
    entries: List[SiteMembershipRequestWithPersonEntry]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "entries": [SiteMembershipRequestWithPersonEntry.from_dict(_item) for _item in obj.get("entries")] if obj.get("entries") is not None else None
        })
        return _obj
