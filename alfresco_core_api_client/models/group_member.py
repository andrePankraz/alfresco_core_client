...
class GroupMember(BaseModel):
    ...
    member_type: StrictStr = Field(alias="memberType")
    __properties: ClassVar[List[str]] = ["id", "displayName", "memberType"]

    @field_validator('member_type')
    def member_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('GROUP', 'PERSON'):
            raise ValueError("must be one of enum values ('GROUP', 'PERSON')")
        return value
