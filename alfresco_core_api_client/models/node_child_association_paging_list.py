...
class NodeChildAssociationPagingList(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "entries": [NodeChildAssociationEntry.from_dict(_item) for _item in obj.get("entries")] if obj.get("entries") is not None else None,
