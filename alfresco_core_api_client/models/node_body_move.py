...
class NodeBodyMove(BaseModel):
    ...
    target_parent_id: StrictStr = Field(alias="targetParentId")
    ...
    __properties: ClassVar[List[str]] = ["targetParentId", "name"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {"targetParentId": obj.get("targetParentId"), "name": obj.get("name")}
        )
        return _obj
