...
class Rating(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "aggregate", "ratedAt", "myRating"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "aggregate": RatingAggregate.from_dict(obj.get("aggregate")) if obj.get("aggregate") is not None else None,
