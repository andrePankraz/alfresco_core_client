...
class AuditEntry(BaseModel):
    ...
    values: Optional[Union[str, Any]] = None
    __properties: ClassVar[List[str]] = ["id", "auditApplicationId", "createdByUser", "createdAt", "values"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "createdByUser": UserInfo.from_dict(obj.get("createdByUser")) if obj.get("createdByUser") is not None else None,
