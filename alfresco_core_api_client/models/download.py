...
class Download(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["filesAdded", "bytesAdded", "id", "totalFiles", "totalBytes", "status"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in ('PENDING', 'CANCELLED', 'IN_PROGRESS', 'DONE', 'MAX_CONTENT_SIZE_EXCEEDED'):
