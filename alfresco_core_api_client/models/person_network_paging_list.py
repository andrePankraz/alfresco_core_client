...
class PersonNetworkPagingList(BaseModel):
    """
    PersonNetworkPagingList
    """ # noqa: E501
    pagination: Pagination
    entries: List[PersonNetworkEntry]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "entries": [PersonNetworkEntry.from_dict(_item) for _item in obj.get("entries")] if obj.get("entries") is not None else None
        })
        return _obj
