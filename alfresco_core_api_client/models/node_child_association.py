...
class NodeChildAssociation(BaseModel):
    """
    ...
    is_direct_link_enabled: Optional[StrictBool] = Field(
        default=None, alias="isDirectLinkEnabled"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "isDirectLinkEnabled": obj.get("isDirectLinkEnabled"),
                ...
                "permissions": PermissionsInfo.from_dict(obj.get("permissions"))
                if obj.get("permissions") is not None
                else None,
                "definition": Definition.from_dict(obj.get("definition"))
                if obj.get("definition") is not None
                else None,
                "association": ChildAssociationInfo.from_dict(obj.get("association"))
