...
from alfresco_core_api_client.models.node_body_create_association import (
...
class NodeBodyCreate(BaseModel):
    ...
    secondary_children: Optional[List[ChildAssociationBody]] = Field(
        default=None, alias="secondaryChildren"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.secondary_children:
            for _item in self.secondary_children:
                if _item:
        ...
        _obj = cls.model_validate(
            {
                ...
                "association": NodeBodyCreateAssociation.from_dict(
                    obj.get("association")
                )
                if obj.get("association") is not None
                else None,
                "secondaryChildren": [
                    ChildAssociationBody.from_dict(_item)
                    for _item in obj.get("secondaryChildren")
                ]
                if obj.get("secondaryChildren") is not None
                else None,
                "targets": [
                    AssociationBody.from_dict(_item) for _item in obj.get("targets")
                ]
