...
class ActionsApi:
    ...
    def get_action_constraint(
        self,
        parameter_constraint_name: Annotated[StrictStr, Field(description="Action parameter constraint name to be returned in the response. ")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        **Note:** this endpoint is available in Alfresco 7.3.0 and newer versions.  Gets action parameter constraint by requested name. Sample reposne: ``` {   \"entry\": {           \"constraintValues\": [               {                   \"value\": \"fa41fd6e-5640-410f-9f3e-93f268186f69\",                   \"label\": \"Start Pooled Review and Approve Workflow\",                   \"isNode\": true               }           ],           \"constraintName\": \"ac-scripts\"       } } ``` 
        ...
        :param parameter_constraint_name: Action parameter constraint name to be returned in the response.  (required)
        :type parameter_constraint_name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_action_constraint_serialize(
            parameter_constraint_name=parameter_constraint_name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_action_constraint_with_http_info(
        self,
        parameter_constraint_name: Annotated[StrictStr, Field(description="Action parameter constraint name to be returned in the response. ")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ActionConstraintEntry]:
        """Retrieve an action parameter constraint by requested name
    ...
    @validate_call
    def get_action_constraint_without_preload_content(
        self,
        parameter_constraint_name: Annotated[StrictStr, Field(description="Action parameter constraint name to be returned in the response. ")],
        _request_timeout: Union[
            None,
    ...
    def _get_action_constraint_serialize(
        self,
        ...
        # process the path parameters
        if parameter_constraint_name is not None:
            _path_params['parameterConstraintName'] = parameter_constraint_name
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/action-parameter-constraints/{parameterConstraintName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
