...
class FavoritesApi:
    ...
    def create_favorite(
        ...
        include: Annotated[Optional[List[StrictStr]], Field(description="Returns additional information about favorites, the following optional fields can be requested: * path (note, this only applies to files and folders) * properties * allowableOperations ")] = None,
        ...
        :param include: Returns additional information about favorites, the following optional fields can be requested: * path (note, this only applies to files and folders) * properties * allowableOperations 
