...
class RatingsApi:
    ...
    def _create_rating_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/nodes/{nodeId}/ratings',
    ...
    def delete_rating(
        self,
        node_id: Annotated[StrictStr, Field(description="The identifier of a node.")],
        rating_id: Annotated[StrictStr, Field(description="The identifier of a rating.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param node_id: The identifier of a node. (required)
        :type node_id: str
        :param rating_id: The identifier of a rating. (required)
        :type rating_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _delete_rating_serialize(
        ...
        if rating_id is not None:
            _path_params['ratingId'] = rating_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/nodes/{nodeId}/ratings/{ratingId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_ratings(
        ...
        _param = self._list_ratings_serialize(
            node_id=node_id,
    ...
    @validate_call
    def list_ratings_with_http_info(
        self,
        node_id: Annotated[StrictStr, Field(description="The identifier of a node.")],
        skip_count: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The number of entities that exist in the collection before those included in this list. If not supplied then the default value is 0. ")] = None,
        max_items: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The maximum number of items to return in the list. If not supplied then the default value is 100. ")] = None,
    ...
    @validate_call
    def list_ratings_without_preload_content(
        self,
        node_id: Annotated[StrictStr, Field(description="The identifier of a node.")],
        skip_count: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The number of entities that exist in the collection before those included in this list. If not supplied then the default value is 0. ")] = None,
        max_items: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The maximum number of items to return in the list. If not supplied then the default value is 100. ")] = None,
