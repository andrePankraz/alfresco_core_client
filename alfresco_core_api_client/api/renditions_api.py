...
class RenditionsApi:
    ...
    @validate_call
    def request_rendition_direct_access_url(
        self,
        node_id: Annotated[StrictStr, Field(description="The identifier of a node.")],
        rendition_id: Annotated[StrictStr, Field(description="The name of a thumbnail rendition, for example *doclib*, or *pdf*.")],
        ...
        **Note:** this endpoint is available in Alfresco 7.1 and newer versions. Generate a direct access content url for the given **nodeId**. 
        ...
        _param = self._request_rendition_direct_access_url_serialize(
            node_id=node_id,
            rendition_id=rendition_id,
    ...
    @validate_call
    def request_rendition_direct_access_url_with_http_info(
        self,
        node_id: Annotated[StrictStr, Field(description="The identifier of a node.")],
        rendition_id: Annotated[StrictStr, Field(description="The name of a thumbnail rendition, for example *doclib*, or *pdf*.")],
        request_content_url_body_create: Annotated[Optional[DirectAccessUrlBodyCreate], Field(description="Direct Access URL options and flags.  Note: It is up to the actual ContentStore implementation if it can fulfil this request or not.  The **attachment** flag controls the download method of the generated URL. It defaults  to **true**, meaning the value for the Content Disposition response header will be **attachment**.  **true** enables a web browser to download the file as an attachment. **false** means a web browser may preview the file in a new tab or window.  You can only set this parameter to **false** if the content type of the file is in the supported list; for example, certain image files and PDF files.  If the content type is not supported for preview, then a value of **false** is ignored, and the attachment will be returned in the response. ")] = None,
    ...
    @validate_call
    def request_rendition_direct_access_url_without_preload_content(
        self,
        node_id: Annotated[StrictStr, Field(description="The identifier of a node.")],
        rendition_id: Annotated[StrictStr, Field(description="The name of a thumbnail rendition, for example *doclib*, or *pdf*.")],
        request_content_url_body_create: Annotated[Optional[DirectAccessUrlBodyCreate], Field(description="Direct Access URL options and flags.  Note: It is up to the actual ContentStore implementation if it can fulfil this request or not.  The **attachment** flag controls the download method of the generated URL. It defaults  to **true**, meaning the value for the Content Disposition response header will be **attachment**.  **true** enables a web browser to download the file as an attachment. **false** means a web browser may preview the file in a new tab or window.  You can only set this parameter to **false** if the content type of the file is in the supported list; for example, certain image files and PDF files.  If the content type is not supported for preview, then a value of **false** is ignored, and the attachment will be returned in the response. ")] = None,
    ...
    def _request_rendition_direct_access_url_serialize(
        self,
        node_id,
        rendition_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/nodes/{nodeId}/renditions/{renditionId}/request-direct-access-url',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
