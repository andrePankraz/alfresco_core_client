...
class VersionsApi:
    ...
    def delete_version_rendition(
        ...
        **Note:** this endpoint is available in Alfresco 7.1.1 and newer versions.  Delete the rendition for **renditionId** of version **versionId** of **nodeId**.  If the rendition is successfully deleted then the content  for that rendition node will be cleared. 
        ...
        _param = self._delete_version_rendition_serialize(
            node_id=node_id,
            version_id=version_id,
    ...
    @validate_call
    def delete_version_rendition_with_http_info(
        self,
        node_id: Annotated[StrictStr, Field(description="The identifier of a node.")],
        version_id: Annotated[StrictStr, Field(description="The identifier of a version, ie. version label, within the version history of a node.")],
        rendition_id: Annotated[StrictStr, Field(description="The name of a thumbnail rendition, for example *doclib*, or *pdf*.")],
    ...
    @validate_call
    def delete_version_rendition_without_preload_content(
        self,
        node_id: Annotated[StrictStr, Field(description="The identifier of a node.")],
        version_id: Annotated[StrictStr, Field(description="The identifier of a version, ie. version label, within the version history of a node.")],
        rendition_id: Annotated[StrictStr, Field(description="The name of a thumbnail rendition, for example *doclib*, or *pdf*.")],
    ...
    def _delete_version_rendition_serialize(
        self,
        node_id,
        version_id,
        rendition_id,
    ...
    @validate_call
    def request_version_direct_access_url(
        self,
        node_id: Annotated[StrictStr, Field(description="The identifier of a node.")],
        version_id: Annotated[StrictStr, Field(description="The identifier of a version, ie. version label, within the version history of a node.")],
        ...
        **Note:** this endpoint is available in Alfresco 7.1 and newer versions. Generate a direct access content url for the given **nodeId**. 
        ...
        _param = self._request_version_direct_access_url_serialize(
            node_id=node_id,
            version_id=version_id,
    ...
    @validate_call
    def request_version_direct_access_url_with_http_info(
        self,
        node_id: Annotated[StrictStr, Field(description="The identifier of a node.")],
        version_id: Annotated[StrictStr, Field(description="The identifier of a version, ie. version label, within the version history of a node.")],
        request_content_url_body_create: Annotated[Optional[DirectAccessUrlBodyCreate], Field(description="Direct Access URL options and flags.  Note: It is up to the actual ContentStore implementation if it can fulfil this request or not.  The **attachment** flag controls the download method of the generated URL. It defaults  to **true**, meaning the value for the Content Disposition response header will be **attachment**.  **true** enables a web browser to download the file as an attachment. **false** means a web browser may preview the file in a new tab or window.  You can only set this parameter to **false** if the content type of the file is in the supported list; for example, certain image files and PDF files.  If the content type is not supported for preview, then a value of **false** is ignored, and the attachment will be returned in the response. ")] = None,
    ...
    @validate_call
    def request_version_direct_access_url_without_preload_content(
        self,
        node_id: Annotated[StrictStr, Field(description="The identifier of a node.")],
        version_id: Annotated[StrictStr, Field(description="The identifier of a version, ie. version label, within the version history of a node.")],
        request_content_url_body_create: Annotated[Optional[DirectAccessUrlBodyCreate], Field(description="Direct Access URL options and flags.  Note: It is up to the actual ContentStore implementation if it can fulfil this request or not.  The **attachment** flag controls the download method of the generated URL. It defaults  to **true**, meaning the value for the Content Disposition response header will be **attachment**.  **true** enables a web browser to download the file as an attachment. **false** means a web browser may preview the file in a new tab or window.  You can only set this parameter to **false** if the content type of the file is in the supported list; for example, certain image files and PDF files.  If the content type is not supported for preview, then a value of **false** is ignored, and the attachment will be returned in the response. ")] = None,
    ...
    def _request_version_direct_access_url_serialize(
        self,
        node_id,
        version_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/nodes/{nodeId}/versions/{versionId}/request-direct-access-url',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def request_version_rendition_direct_access_url(
        self,
        node_id: Annotated[StrictStr, Field(description="The identifier of a node.")],
        version_id: Annotated[StrictStr, Field(description="The identifier of a version, ie. version label, within the version history of a node.")],
        rendition_id: Annotated[StrictStr, Field(description="The name of a thumbnail rendition, for example *doclib*, or *pdf*.")],
        request_content_url_body_create: Annotated[Optional[DirectAccessUrlBodyCreate], Field(description="Direct Access URL options and flags.  It can be used to set the **attachment** flag, which controls the download method of the generated URL (attachment DAU vs embedded DAU). It defaults to **true**, meaning the value for the Content Disposition response header will be **attachment**.  Note: It is up to the actual ContentStore implementation if it can fulfil this request or not. ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        **Note:** this endpoint is available in Alfresco 7.2 and newer versions. Generate a direct access content url for the given **nodeId**. 
        ...
        :param rendition_id: The name of a thumbnail rendition, for example *doclib*, or *pdf*. (required)
        :type rendition_id: str
        :param request_content_url_body_create: Direct Access URL options and flags.  It can be used to set the **attachment** flag, which controls the download method of the generated URL (attachment DAU vs embedded DAU). It defaults to **true**, meaning the value for the Content Disposition response header will be **attachment**.  Note: It is up to the actual ContentStore implementation if it can fulfil this request or not. 
        :type request_content_url_body_create: DirectAccessUrlBodyCreate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._request_version_rendition_direct_access_url_serialize(
            node_id=node_id,
            version_id=version_id,
            rendition_id=rendition_id,
            request_content_url_body_create=request_content_url_body_create,
    ...
    @validate_call
    def request_version_rendition_direct_access_url_with_http_info(
        self,
        node_id: Annotated[StrictStr, Field(description="The identifier of a node.")],
        version_id: Annotated[StrictStr, Field(description="The identifier of a version, ie. version label, within the version history of a node.")],
        rendition_id: Annotated[StrictStr, Field(description="The name of a thumbnail rendition, for example *doclib*, or *pdf*.")],
    ...
    @validate_call
    def request_version_rendition_direct_access_url_without_preload_content(
        self,
        node_id: Annotated[StrictStr, Field(description="The identifier of a node.")],
        version_id: Annotated[StrictStr, Field(description="The identifier of a version, ie. version label, within the version history of a node.")],
        rendition_id: Annotated[StrictStr, Field(description="The name of a thumbnail rendition, for example *doclib*, or *pdf*.")],
    ...
    def _request_version_rendition_direct_access_url_serialize(
        self,
        node_id,
        version_id,
        rendition_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/nodes/{nodeId}/versions/{versionId}/renditions/{renditionId}/request-direct-access-url',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
