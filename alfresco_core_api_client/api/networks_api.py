...
class NetworksApi:
    ...
    def get_network(
        self,
        network_id: Annotated[StrictStr, Field(description="The identifier of a network.")],
        ...
        :param network_id: The identifier of a network. (required)
        :type network_id: str
    ...
    def get_network_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PersonNetworkEntry]:
        """Get a network
    ...
    def get_network_for_person(
        ...
        _param = self._get_network_for_person_serialize(
            person_id=person_id,
            network_id=network_id,
            fields=fields,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_network_for_person_with_http_info(
        self,
        person_id: Annotated[StrictStr, Field(description="The identifier of a person.")],
        network_id: Annotated[StrictStr, Field(description="The identifier of a network.")],
        fields: Annotated[Optional[List[StrictStr]], Field(description="A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. ")] = None,
    ...
    @validate_call
    def get_network_for_person_without_preload_content(
        self,
        person_id: Annotated[StrictStr, Field(description="The identifier of a person.")],
        network_id: Annotated[StrictStr, Field(description="The identifier of a network.")],
        fields: Annotated[Optional[List[StrictStr]], Field(description="A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. ")] = None,
    ...
    def _get_network_for_person_serialize(
        self,
        person_id,
        network_id,
        fields,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/people/{personId}/networks/{networkId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_networks_for_person(
        ...
        _param = self._list_networks_for_person_serialize(
            person_id=person_id,
    ...
    @validate_call
    def list_networks_for_person_with_http_info(
        self,
        person_id: Annotated[StrictStr, Field(description="The identifier of a person.")],
        skip_count: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The number of entities that exist in the collection before those included in this list. If not supplied then the default value is 0. ")] = None,
        max_items: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The maximum number of items to return in the list. If not supplied then the default value is 100. ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PersonNetworkPaging]:
        """List network membership
    ...
    @validate_call
    def list_networks_for_person_without_preload_content(
        self,
        person_id: Annotated[StrictStr, Field(description="The identifier of a person.")],
        skip_count: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The number of entities that exist in the collection before those included in this list. If not supplied then the default value is 0. ")] = None,
        max_items: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The maximum number of items to return in the list. If not supplied then the default value is 100. ")] = None,
    ...
    def _list_networks_for_person_serialize(
        self,
        person_id,
        skip_count,
        max_items,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/people/{personId}/networks',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
